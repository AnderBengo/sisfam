...
export class EstructuraFamiliarComponent implements OnInit {
  ...
  familias: Familia[] = [
    ...
    {id: 1,nombre: 'Bengolea Sánchez',celular:'',zona:'', nombreZona: '',tipoVia: '', nombreTipoVia: '',referencia: '',integrantesFamiliar: [this.integranteFamiliar1, this.integranteFamiliar2]},
    {id: 2,nombre: 'Arotinco Velasquez',celular:'',zona:'01 URB.', nombreZona: 'BARDALES MERA',tipoVia: '', nombreTipoVia: '',referencia: '',integrantesFamiliar: [this.integranteFamiliar3]},
